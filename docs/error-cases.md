...
| 상황 | 동작 |
|---|---|
| 존재하지 않는 보스명 컷/멍 | "❌ **{query}** 에 해당하는 보스를 찾을 수 없습니다." |
| 고정 보스 컷/멍 시도 | "❌ **{name}** 은 고정 일정 보스로 컷/멍 처리가 불필요합니다." |
| 리스폰 미설정 보스 컷/멍 | "❌ **{name}** 은 리스폰이 설정되지 않았습니다." |
...
| 상황 | 동작 |
|---|---|
| 존재하지 않는 보스 삭제 시도 | "❌ **{name}** 을(를) 찾을 수 없습니다." |
| 기본 보스(`is_default=1`) 삭제 시도 | "🔒 **{name}** 은 기본 보스로 삭제할 수 없습니다." |
